...
<body>
	...
	<div style="text-align: center; margin-bottom: 20px;">
		<input type="text" id="searchInput" placeholder="챔피언 이름 검색"
	...
	<div class="champion-list" id="championList">
		<c:forEach var="champion" items="${championList}">
			<div class="champion-card" data-name="${champion.name}">
				<a href="/champion/detail/${champion.id}"> <img
					src="https://ddragon.leagueoflegends.com/cdn/14.4.1/img/champion/${champion.image}"
					alt="${champion.name}"
					onerror="this.onerror=null; this.src='https://kr.object.ncloudstorage.com/bitcamp.bucket/champion/nonoimage.png';" />
